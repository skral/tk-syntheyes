...
class SyntheyesGeometryPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(SyntheyesGeometryPublishPlugin, self).settings or {}

        # settings specific to this class
        syntheyes_geometry_publish_settings = {
            "Publish Template": {
                "type": "template",
                "default": None,
        ...
        base_settings.update(syntheyes_geometry_publish_settings)
    ...
    def accept(self, settings, item):
        ...
        template_name = "syntheyes_shot_scene_publish_abc"
    ...
    def validate(self, settings, item):
        ...
        # validating the scene resolution with the plate
        ...
        return super(SyntheyesGeometryPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        abc_publish_path = item.local_properties["publish_path"]


        # ensure the publish folder exists:
        self.parent.ensure_folder_exists(os.path.dirname(abc_publish_path))

        hlev = item.properties["hlev"]
        #exporting the alembic data
        hlev.Export("Alembic 1.5+", abc_publish_path)
        ...
        super(SyntheyesGeometryPublishPlugin, self).publish(settings, item)
